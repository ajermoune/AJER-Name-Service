...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("AJER Name Service", _tld) {
    ...
    function register(string calldata _name) public payable {
        ...
        string memory strLen = Strings.toString(StringUtils.strlen(name));
        ...
        string memory json = Base64.encode(
            bytes (
                string (
                    ...
                    '{"name": "'
                    ,name,
                    '", "description": "A domain on the AJER Name Service", "image": "data:image/svg+xml;base64,',
    ...
    function getAllNames() public view returns (string[] memory) {
        ...
        uint tokenNum = tokenIds.current();
